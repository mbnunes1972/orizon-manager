...
- **Frontend (`static/index.html`):** `gerarContrato()` trata `precisa_confirmar_loja` com diálogo "Gerar assim? / Cancelar" e re-chama com a flag, reaproveitando o signatário já coletado (sem reperguntar).
