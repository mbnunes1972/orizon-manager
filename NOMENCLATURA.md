...
| `Prov_Mont` | Provisão de Montagem (visão) | `%montagem_pct × Val_Cont` — mesma base/valor da constituição contábil no fechamento (5.6.02 × 2.1.04.02); é rubrica do `Cust_Var` (fold FASE 2) |
| `Prov_Gar` | Provisão de Garantia (visão) | `%garantia_pct × Val_Cont` — mesma base/valor da constituição contábil no fechamento (5.6.01 × 2.1.04.03); é rubrica do `Cust_Var` (fold FASE 2) |
